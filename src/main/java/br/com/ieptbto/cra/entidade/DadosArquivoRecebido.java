...
public class DadosArquivoRecebido extends AbstractEntidade<DadosArquivoRecebido> {
	...
	public static DadosArquivoRecebido set(String login, String senha, String nomeArquivo, String dados, String servico, Date data) throws IOException {
	...
	public static DadosArquivoRecebido set(String login, String senha, String nomeArquivo, String dados, String servico) throws IOException {
