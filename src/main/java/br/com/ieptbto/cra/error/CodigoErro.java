...
public enum CodigoErro {
						...
						CRA_JA_FOI_ENVIADA_REMESSA_COM_O_MESMO_SEQUENCIAL_PARA_O_MUNICIPIO(" 2117",
						...
						CRA_EXISTE_REMESSA_NO_ARQUIVO_COM_O_MESMO_SEQUENCIAL_PARA_O_MUNICIPIO(" 2119",
						...
						CRA_ARQUIVO_CORROMPIDO_SOMATORIO_DE_SEGURANCA_DOS_REGISTROS_NAO_CONFERE_COM_A_SOMA_DAS_QUANTIDADES_INFORMADAS_NO_HEADER(
								" 2136",
						...
						CARTORIO_PROTOCOLO_VAZIO_SEM_OCORRENCIA_DE_DEVOLUCAO("103",
								"Protocolo vazio ou zerado e sem Tipo Ocorrência de Devolução"),
						...
						CARTORIO_TITULO_NAO_ENCONTRADO_PROTOCOLO_INEXISTENTE("106",
								"Título não encontrado, protocolo inexistente ou não foi enviada confirmação"),
