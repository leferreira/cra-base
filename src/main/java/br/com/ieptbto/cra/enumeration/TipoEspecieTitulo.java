...
public enum TipoEspecieTitulo implements CraEnum {
    ...
    ATC("ATC", "ATC - Acórdão do Tribunal de Contas da União"), CBI(
	    "CBI",
		"CBI - Cédula de Crédito Bancário por Indicação"), CDA("CDA", "CDA - Certidão Dívida Ativa"), CH(
			"CH",
			    "CH - Cheque"), CTR("CTR", "CTR - Contrato"), DMI(
				    "DMI",
					"DMI - Duplicata Venda Mercantil por Indicação"), DSI(
						"DSI",
						    "DSI - Duplicata de Prestação de Serviços"), EC(
							    "EC",
								"EC - Encargos Condominiais"), NP(
									"NP",
									    "NP - Nota Promissória"), SJ(
										    "SJ",
