 ...
 */
@Service
public class ProcessadorDesistenciaCancelamentoConvenio extends Processador {
	...
	private Arquivo criarArquivoCancelamentoProtesto(String codigoPortador, CancelamentoProtesto cancelamentoProtesto) {
		...
		arquivo.setInstituicaoRecebe(instituicaoDAO.buscarInstituicaoPorNomeFantasia("CRA"));
		...
		arquivo.setNomeArquivo(gerarNomeArquivo(arquivo.getInstituicaoEnvio(), TipoArquivoFebraban.CANCELAMENTO_DE_PROTESTO));
	...
	private PedidoCancelamento adicionarRegistroPedidoCancelamento(TituloRemessa titulo,
		...
		Confirmacao conf = confirmacaoMediator.buscarConfirmacaoPorTitulo(titulo);
	...
	private Arquivo criarArquivoAutorizacaoCancelamento(String codigoPortador, AutorizacaoCancelamento autorizacaoCancelamento) {
		...
		arquivo.setUsuarioEnvio(getUsuario());
		arquivo.setStatusArquivo(getStatusArquivo());
		arquivo.setNomeArquivo(gerarNomeArquivo(arquivo.getInstituicaoEnvio(), TipoArquivoFebraban.AUTORIZACAO_DE_CANCELAMENTO));
	...
	private Arquivo criarArquivoDesistenciaProtesto(String codigoPortador, DesistenciaProtesto desistenciaProtesto) {
		...
		arquivo.setUsuarioEnvio(getUsuario());
		arquivo.setStatusArquivo(getStatusArquivo());
		arquivo.setNomeArquivo(gerarNomeArquivo(arquivo.getInstituicaoEnvio(), TipoArquivoFebraban.DEVOLUCAO_DE_PROTESTO));
	...
	private String gerarNomeArquivo(Instituicao instituicaoEnvio, TipoArquivoFebraban tipoArquivo) {
