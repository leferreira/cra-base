...
public enum CodigoErro {
	...
	SERPRO_SUCESSO_REMESSA("0000", "REGISTROS OK - AGUARDANDO DISTRIBUIÇÃO."),
	SERPRO_SUCESSO_DESISTENCIA_CANCELAMENTO("0000", "SOLICITAÇÃO RECEBIDA COM SUCESSO.."),
	SERPRO_FALHA_NA_AUTENTICACAO("0001", "FALHA NA AUTENTICAÇÃO."),
	SERPRO_NOME_ARQUIVO_INVALIDO_REMESSA_DESISTENCIA_CANCELAMENTO("0002", "NOME DO ARQUIVO INVÁLIDO."),
	SERPRO_NOME_ARQUIVO_INVALIDO_CONFIRMACAO_RETORNO("0002", "NOME DO ARQUIVO INVÁLIDO."),
	SERPRO_ESTE_PROCESSO_TERMINOU_REMESSA_DESISTENCIA_CANCELAMENTO("0003", "ESTE PROCESSO JÁ TERMINOU - HORÁRIO."),
	SERPRO_AGUARDE_CONFIRMACAO_EM_PROCESSAMENTO("0003", "AGUARDE CONFIRMAÇÃO EM PROCESSAMENTO."),
	SERPRO_NAO_HA_REGISTRO_DE_RETORNO_NESTA_DATA("0003", "NÃO HÁ REGISTRO DE RETORNO NESTA DATA."),
	SERPRO_ARQUIVO_INVALIDO_REMESSA_DESISTENCIA_CANCELAMENTO("0004", "ARQUIVO INVÁLIDO."),
	SERPRO_NAO_EXISTE_REMESSA_PARA_A_CONFIRMACAO("0004", "NÃO EXISTE REMESSA PARA A CONFIRMAÇÃO.");
