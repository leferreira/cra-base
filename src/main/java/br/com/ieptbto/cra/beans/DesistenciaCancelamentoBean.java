 ...
 *
 */
public class DesistenciaCancelamentoBean implements Serializable {
	...
	public void parseDesistenciaProtesto(DesistenciaProtesto desistencia) {
		this.tipoArquivo = TipoArquivoFebraban.DEVOLUCAO_DE_PROTESTO;
	...
	public void parseCancelamentoProtesto(CancelamentoProtesto cancelamentoProtesto) {
		this.tipoArquivo = TipoArquivoFebraban.CANCELAMENTO_DE_PROTESTO;
	...
	public void parseAutorizacaoCancelamento(AutorizacaoCancelamento autorizacaoCancelamento) {
		this.tipoArquivo = TipoArquivoFebraban.AUTORIZACAO_DE_CANCELAMENTO;
