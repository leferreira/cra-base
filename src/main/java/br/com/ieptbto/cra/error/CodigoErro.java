...
public enum CodigoErro {
	...
	CRA_ARQUIVO_CORROMPIDO_NUMERO_DE_CONTROLE_DO_DEVEDOR_NAO_ESTA_CONTINUO(
																			" 2107",
																			"Arquivo corrompido. Número de controle do devedor (XXX) não está contínuo."),
	CRA_ARQUIVO_CORROMPIDO_SOMA_DE_TITULOS_EXISTENTES_NO_ARQUIVO_NAO_CONFERE_COM_TOTAL_INFORMADO_NO_HEADER(
																											" 2108",
																											"Arquivo corrompido. Soma de títulos existentes no arquivo (XXX) não confere com total informado no header (XXX)."),
	CRA_ARQUIVO_CORROMPIDO_SOMA_DE_INDICACOES_EXISTENTES_NO_ARQUIVO_NAO_CONFERE_COM_TOTAL_INFORMADO_NO_HEADER(
																												" 2109",
																												"Arquivo corrompido. Soma de indicações existentes no arquivo (XXX) não confere com total informado no header (XXX)."),
	CRA_ARQUIVO_CORROMPIDO_SOMA_DE_ORIGINAIS_EXISTENTES_NO_ARQUIVO_NAO_CONFERE_COM_TOTAL_INFORMADO_NO_HEADER(
																												" 2110",
	...
	CRA_ARQUIVO_CORROMPIDO_NUMERO_SEQUENCIAL_DO_REGISTRO_NO_HEADER_NAO_ESTA_CONTINUO_FALTOU_REGISTRO(
																										" 2114",
	...
	CRA_EXISTE_REMESSA_NO_ARQUIVO_COM_O_MESMO_SEQUENCIAL_PARA_O_MUNICIPIO(
																			" 2119",
																			"Existe remessa no arquivo com o mesmo sequencial (XXX) para o município (XXX)."),
	CRA_ARQUIVO_CORROMPIDO_NUMERO_SEQUENCIAL_DO_REGISTRO_NA_TRANSACAO_NAO_ESTA_CONTINUO_FALTOU_REGISTRO(
																										" 2120",
																										"Arquivo corrompido. Número sequencial do registro na transação (XXX) não está contínuo. Faltou registro (XXX)."),
	CRA_ARQUIVO_CORROMPIDO_NUMERO_SEQUENCIAL_DO_REGISTRO_NO_TRAILLER_NAO_ESTA_CONTINUO_FALTOU_REGISTRO(
																										" 2121",
