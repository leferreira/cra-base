...
@XmlType(propOrder = { "identificacaoRegistro", "codigoPortador", "agenciaCodigoCedente", "nomeCedenteFavorecido", "nomeSacadorVendedor", "documentoSacador", "enderecoSacadorVendedor", "cepSacadorVendedor", "cidadeSacadorVendedor", "ufSacadorVendedor", "nossoNumero", "especieTitulo", "numeroTitulo", "dataEmissaoTitulo", "dataVencimentoTitulo", "tipoMoeda", "valorTitulo", "saldoTitulo" })
public class TituloVO extends AbstractArquivoVO {
	...
	for (PropertyDescriptor propertyDescriptor : propertyDescriptors) {
	    ...
	    if (propertyAccessCCR.isReadableProperty(propertyName)
		    && propertyAccessTituloVO.isWritableProperty(propertyName)) {
		String valor = "";
