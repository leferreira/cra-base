...
public class RodapeArquivoCancelamentoProtestoVO extends AbstractArquivoVO {

	@XmlAttribute(name = "h01")
	@IAtributoArquivo(ordem = 1, posicao = 1, tamanho = 1, descricao = "Identificar tipo registro Cabeçalho Arquivo Cancelamenteo Protesto. Constante 9.", obrigatoriedade = true, validacao = "9", tipo = Integer.class)
	...
	@IAtributoArquivo(ordem = 5, posicao = 58, tamanho = 5, formato = "0", posicaoCampoVazio = PosicaoCampoVazio.ESQUERDO, descricao = "Quantidade de Cancelamentos. Informada no Cabeçalho.", obrigatoriedade = true)
