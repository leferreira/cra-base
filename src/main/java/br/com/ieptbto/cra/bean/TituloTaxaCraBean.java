 ...
 *
 *         Bean criado para relatorio de taxa cra para titulos pagos
 */
public class TituloTaxaCraBean implements Serializable {
	...
	public void parseToTituloRemessa(TituloRemessa tituloRemessa) {
		...
		this.numeroDocumentoDevedor = tituloRemessa.getNumeroIdentificacaoDevedor();
	...
	public static List<TituloTaxaCraBean> parseToListTitulo(List<TituloRemessa> titulos) {
		List<TituloTaxaCraBean> titulosBean = new ArrayList<TituloTaxaCraBean>();
	...
	public TaxaCra getTaxaCra() {
		return taxaCra;
	}

	public void setTaxaCra(TaxaCra taxaCra) {
