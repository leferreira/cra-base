...
@Entity
@Audited
@Table(name = "TB_PEDIDO_AUTORIZACAO_CANCELAMENTO")
@org.hibernate.annotations.Table(appliesTo = "TB_PEDIDO_AUTORIZACAO_CANCELAMENTO")
public class PedidoAutorizacaoCancelamento extends AbstractEntidade<PedidoAutorizacaoCancelamento> {
	...
	@Override
	@Id
	@Column(name = "ID_PEDIDO_AUTORIZACAO_CANCELAMENTO", columnDefinition = "serial")
	...
	@ManyToOne
	@JoinColumn(name = "AUTORIZACAO_CANCELAMENTO_ID")
	...
	@Override
	public int compareTo(PedidoAutorizacaoCancelamento entidade) {
