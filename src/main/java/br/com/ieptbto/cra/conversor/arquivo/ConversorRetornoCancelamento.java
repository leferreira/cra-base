...
import br.com.ieptbto.cra.entidade.RetornoCancelamento;
 ...
 *
 */
public class ConversorRetornoCancelamento extends AbstractConversorArquivo<TituloVO, Retorno> {
     ...
     * @return
     */
    public TituloVO converter(RetornoCancelamento entidade, Class<TituloVO> arquivoVO) {
