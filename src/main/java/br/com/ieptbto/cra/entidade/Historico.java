...
public class Historico extends AbstractEntidade<Historico> {
	...
	public String toString() {
		return "Arquivo " + remessa.getArquivo().getNomeArquivo() + " importado em "
		        + DataUtil.localDateToString(dataOcorrencia.toLocalDate()) + " às " + dataOcorrencia.toDateTime().toString() + " por "
		        + usuarioAcao.getNome() + ".";
	}
